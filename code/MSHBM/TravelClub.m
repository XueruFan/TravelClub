...
project_dir = '/Volumes/FanXueru/TravelClub';
code_dir = '/Users/xuerufan/TravelClub/code/MSHBM'; 
...
addpath(genpath('/Volumes/FanXueru/TravelClub'));
...
% 生成功能连接矩阵，由于多回波ICA融合时会进行降噪，在step0里需要小心设置阈值
